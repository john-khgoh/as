...
y_train_df['coordinates'] = y_train_df.values.tolist()
y_train_df = y_train_df.drop(columns=['x','y'])
#y_train_df['coordinates'] = y_train_df['coordinates'].apply(np.array)
y_test_df['coordinates'] = y_test_df.values.tolist()
y_test_df = y_test_df.drop(columns=['x','y'])
#y_test_df['coordinates'] = y_test_df['coordinates'].apply(np.array)

x_train_df = x_train_df.replace(to_replace=pd.NA, value=None)
y_train_df = y_train_df.replace(to_replace=pd.NA, value=None)

#Training the model
#Check every row of x_train_arr and y_train_arr for NaN/bool type
